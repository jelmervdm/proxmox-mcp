"""TDQS (Tool Definition Quality Score) Evaluator for Proxmox MCP Server.
...
def evaluate_tdqs() -> None:
    ...
    for name, tool in tools.items():
        ...
        has_usage = (
            ...
            or "start" in doc.lower()
            or "stop" in doc.lower()
            or "manage" in doc.lower()
            or "read" in doc.lower()
            or "run" in doc.lower()
            or "generate" in doc.lower()
            or "scan" in doc.lower()
            or "send" in doc.lower()
            or "convert" in doc.lower()
            or "resize" in doc.lower()
            or "move" in doc.lower()
            or "rollback" in doc.lower()
            or "dump" in doc.lower()
            or "allocate" in doc.lower()
            or "prune" in doc.lower()
            or "initialize" in doc.lower()
            or "join" in doc.lower()
            or "test" in doc.lower()
            or "bulk" in doc.lower()
            or "sync" in doc.lower()
            or "change" in doc.lower()
            or "order" in doc.lower()
            or "make" in doc.lower()
            or "perform" in doc.lower()
            or "set" in doc.lower()
            or "check" in doc.lower()
            or "relocate" in doc.lower()
            or "apply" in doc.lower()
            or "register" in doc.lower()
            or "suspend" in doc.lower()
            or "resume" in doc.lower()
            or "reboot" in doc.lower()
            or "shutdown" in doc.lower()
            or "clone" in doc.lower()
            or "migrate" in doc.lower()
            or "reset" in doc.lower()
        )
        if has_usage:
